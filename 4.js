...
//     return _.startsWith(crypto.createHash('md5').update(test).digest('hex'), '00000') ? test : miner(secretKey, curTest+1);
// };
...
while (!found) {
    ...
    found = _.startsWith(crypto.createHash('md5').update(test).digest('hex'), '00000');
